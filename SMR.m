...
Keq = exp(23700/T - 8.424*log(T) - 1.571); %atm^-2
%Keq = (exp(30.53 - 4.8486e4/T +2.421748e6/T^2 + 2.49e9/T^3 ))

z = 1000/T - 1;
Keq = 1/ ((1.0267e10* exp(-0.2513*z^4 + 0.3665*z^3 + 0.5810*z^2 - 27.134*z + 3.2770)/101325^2)); %Pa^2
...
if X < 0.5
    ...
    %kf = 3.92e2*exp(6.77/(R*1e-3*T))*100^3; %mol/s-m^3-atm^2
    %kf = 3.92e2*exp(6.77/(R*1e-3*T))*100^3/(101325^2); %mol/s-m^3-atm^2
